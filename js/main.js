...
app.init = function() {
    ...
    app.spotLight.position.set(600, 100, 100);
    ...
    */
    ...
    var renderOverlay = function(points, speed, countryColor) {
      ...
      for (var i = 0; i < points.length; i++) {
        ...
        // calculate the position where to start the cube
        ...
        //////////////////////////////////////////
        var cube = new THREE.Mesh(new THREE.CubeGeometry(1, 1, (speed * 8)));
    ...
    $.getJSON("/js/list.geo.json", function(json) {
      ...
      for (var i = 0; i < allCountries.length; i++) {
        ...
        if (isSingleLandMass) {
          ...
          renderOverlay(points, countrySpeed, countryColor);
          // create shape
